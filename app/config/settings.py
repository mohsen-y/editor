...
SECRET_KEY = "django-insecure-v%iyz$lvoyq*vs5#l!syrb*$%#gd6&vyj=rrk3#$+ocffvuv7f"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # TODO: to be set to False
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.sqlite3",  # TODO: change database engine
